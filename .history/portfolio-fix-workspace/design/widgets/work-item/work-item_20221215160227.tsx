...
export type WorkItemProps = {
  ...
  */
   ...
   */
  period: string;
}; // extend the props with the sizeable box props.

export function WorkItem({ company, designation, period, size }: WorkItemProps) { // ...rest
  // destructuring the rest props and passing them to the SizeableBox
  return (
    <SizeableBox
      size={size}
    >
